...
! function(t, e) { "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("simpleParallax", [], e) : "object" == typeof exports ? exports.simpleParallax = e() : t.simpleParallax = e() }(window, function() {
    return (n = {}, s.m = i = [function(t, e, i) {
        ...
        var s = function() {
            ...
            r = function() { for (var t, e = "transform webkitTransform mozTransform oTransform msTransform".split(" "), i = 0; void 0 === t;) t = void 0 !== document.createElement("div").style[e[i]] ? e[i] : void 0, i += 1; return t }(),
        ...
        var h = function() {
            ...
            return function(t, e, i) { e && u(t.prototype, e), i && u(t, i) }(i, [{ key: "init", value: function() { this.isInit || this.element.closest(".simpleParallax") || (!1 === this.settings.overflow && this.wrapElement(this.element), this.setStyle(), this.getElementOffset(), this.intersectionObserver(), this.getTranslateValue(), this.animate(), this.isInit = !0) } }, {
                key: "wrapElement",
                value: function() {
            ...
            }, { key: "intersectionObserverCallback", value: function(t) { for (var e = t.length - 1; 0 <= e; e--) t[e].isIntersecting ? this.isVisible = !0 : this.isVisible = !1 } }, { key: "checkIfVisible", value: function() { return this.elementBottom > d.positions.top && this.elementTop < d.positions.bottom } }, {
                key: "getRangeMax",
                value: function() {
                    var t = this.element.clientHeight;
                    this.rangeMax = t * this.settings.scale - t
                }
            }, { key: "getTranslateValue", value: function() { var t = ((d.positions.bottom - this.elementTop) / ((d.positions.height + this.elementHeight) / 100)).toFixed(1); return t = Math.min(100, Math.max(0, t)), this.oldPercentage !== t && (this.rangeMax || this.getRangeMax(), this.translateValue = (t / 100 * this.rangeMax - this.rangeMax / 2).toFixed(0), this.oldTranslateValue !== this.translateValue && (this.oldPercentage = t, this.oldTranslateValue = this.translateValue, !0)) } }, {
                key: "animate",
                value: function() {
                    var t, e = 0,
                        i = 0;
        ...
        i.d(e, "viewport", function() { return d }), i.d(e, "default", function() { return b });
        var f, p, m, d = new s,
            g = !0,
            v = !1,
            y = [],
            b = function() {
                ...
                return function(t, e, i) { e && c(t.prototype, e), i && c(t, i) }(i, [{
                    key: "init",
                    value: function() {
                        d.setViewportAll();
                ...
                }, { key: "resizeIsDone", value: function() { clearTimeout(m), m = setTimeout(this.handleResize, 500) } }, {
                    key: "handleResize",
                    value: function() {
    ...
    }], s.c = n, s.d = function(t, e, i) { s.o(t, e) || Object.defineProperty(t, e, { enumerable: !0, get: i }) }, s.r = function(t) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(t, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t, "__esModule", { value: !0 }) }, s.t = function(e, t) {
        ...
        return i
    }, s.n = function(t) { var e = t && t.__esModule ? function() { return t["default"] } : function() { return t }; return s.d(e, "a", e), e }, s.o = function(t, e) { return Object.prototype.hasOwnProperty.call(t, e) }, s.p = "", s(s.s = 0))["default"];
...
(function(modules) {
    ...
    "use strict";
    module.exports = function(callback) { if (document.readyState === "complete" || document.readyState === "interactive") { callback.call() } else if (document.attachEvent) { document.attachEvent("onreadystatechange", function() { if (document.readyState === "interactive") callback.call() }) } else if (document.addEventListener) { document.addEventListener("DOMContentLoaded", callback) } }
}, , function(module, exports, __webpack_require__) {
    "use strict";
    (function(global) {
        var win;
    ...
    try { g = g || Function("return this")() || (1, eval)("this") } catch (e) { if ((typeof window === "undefined" ? "undefined" : _typeof(window)) === "object") g = window }
    module.exports = g
}, function(module, exports, __webpack_require__) { module.exports = __webpack_require__(7) }, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    (0, _liteReady2["default"])(function() { if (typeof jarallax !== "undefined") { jarallax(document.querySelectorAll("[data-jarallax-video]")) } })
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    var VideoWorker = function() {
        ...
        _createClass(VideoWorker, [{
            ...
            value: function extend(out) {
                ...
                Object.keys(arguments).forEach(function(i) {
                    if (!_arguments[i]) { return }
                    Object.keys(_arguments[i]).forEach(function(key) { out[key] = _arguments[i][key] })
                });
                return out
            }
        }, {
            ...
            value: function parseURL(url) {
                function getYoutubeID(ytUrl) { var regExp = /.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/; var match = ytUrl.match(regExp); return match && match[1].length === 11 ? match[1] : false }
                ...
                if (Youtube) { this.type = "youtube"; return Youtube } else if (Vimeo) { this.type = "vimeo"; return Vimeo } else if (Local) { this.type = "local"; return Local }
                return false
            }
        ...
        }, { key: "off", value: function off(name, callback) { var _this = this; if (!this.userEventsList || !this.userEventsList[name]) { return } if (!callback) { delete this.userEventsList[name] } else { this.userEventsList[name].forEach(function(val, key) { if (val === callback) { _this.userEventsList[name][key] = false } }) } } }, { key: "fire", value: function fire(name) { var _this2 = this; var args = [].slice.call(arguments, 1); if (this.userEventsList && typeof this.userEventsList[name] !== "undefined") { this.userEventsList[name].forEach(function(val) { if (val) { val.apply(_this2, args) } }) } } }, {
            key: "play",
            value: function play(start) {
                var self = this;
                if (!self.player) { return }
                if (self.type === "youtube" && self.player.playVideo) { if (typeof start !== "undefined") { self.player.seekTo(start || 0) } if (YT.PlayerState.PLAYING !== self.player.getPlayerState()) { self.player.playVideo() } }
                if (self.type === "vimeo") {
        ...
        }, { key: "getIframe", value: function getIframe(callback) { this.getVideo(callback) } }, {
            key: "getVideo",
            value: function getVideo(callback) {
                var self = this;
                if (self.$video) { callback(self.$video); return }
                self.onAPIready(function() {
                    ...
                    if (self.type === "youtube") {
                        ...
                        self.playerOptions.events = {
                            onReady: function onReady(e) {
                                if (self.options.mute) { e.target.mute() } else if (self.options.volume) { e.target.setVolume(self.options.volume) }
                            ...
                            onStateChange: function onStateChange(e) {
                                if (self.options.loop && e.data === YT.PlayerState.ENDED) { self.play(self.options.startTime) }
                                ...
                                if (e.data === YT.PlayerState.PLAYING) { ytProgressInterval = setInterval(function() { self.fire("timeupdate", e); if (self.options.endTime && self.player.getCurrentTime() >= self.options.endTime) { if (self.options.loop) { self.play(self.options.startTime) } else { self.pause() } } }, 150) } else { clearInterval(ytProgressInterval) }
                            }
                        };
                    ...
                    if (self.type === "vimeo") {
                        ...
                        self.player.getVideoWidth().then(function(width) { self.videoWidth = width || 1280 });
                        self.player.getVideoHeight().then(function(height) { self.videoHeight = height || 720 });
                        ...
                        self.player.on("timeupdate", function(e) {
                            ...
                            if (self.options.endTime) { if (self.options.endTime && e.seconds >= self.options.endTime) { if (self.options.loop) { self.play(self.options.startTime) } else { self.pause() } } }
                        });
                        self.player.on("play", function(e) { self.fire("play", e); if (self.options.startTime && e.seconds === 0) { self.play(self.options.startTime) } });
                        ...
                        self.player.on("volumechange", function(e) { self.fire("volumechange", e) })
                    }
                    ...
                    if (self.type === "local") {
                        if (!self.$video) {
                            ...
                            hiddenDiv.appendChild(self.$video);
                            document.body.appendChild(hiddenDiv);
                            Object.keys(self.videoID).forEach(function(key) { addSourceToLocal(self.$video, self.videoID[key], "video/" + key) })
                        }
                        ...
                        self.player.addEventListener("timeupdate", function(e) { self.fire("timeupdate", e); if (self.options.endTime) { if (self.options.endTime && this.currentTime >= self.options.endTime) { if (self.options.loop) { self.play(self.options.startTime) } else { self.pause() } } } });
                        self.player.addEventListener("play", function(e) { self.fire("play", e) });
                        self.player.addEventListener("pause", function(e) { self.fire("pause", e) });
                        self.player.addEventListener("ended", function(e) { self.fire("ended", e) });
            ...
            value: function onAPIready(callback) {
                ...
                if (self.type === "youtube") {
                    ...
                    } else if ((typeof YT === "undefined" ? "undefined" : _typeof(YT)) === "object" && YT.loaded === 1) { callback() } else { loadingYoutubeDefer.done(function() { callback() }) }
                }
                if (self.type === "vimeo") {
                    ...
                    } else if (typeof Vimeo !== "undefined") { callback() } else { loadingVimeoDefer.done(function() { callback() }) }
                }
    ...
    function jarallaxVideo() {
        ...
        Jarallax.prototype.initImg = function() { var self = this; var defaultResult = defInitImg.apply(self); if (!self.options.videoSrc) { self.options.videoSrc = self.$item.getAttribute("data-jarallax-video") || null } if (self.options.videoSrc) { self.defaultInitImgResult = defaultResult; return true } return defaultResult };
        var defCanInitParallax = Jarallax.prototype.canInitParallax;
        Jarallax.prototype.canInitParallax = function() {
            var self = this;
            var defaultResult = defCanInitParallax.apply(self);
            if (!self.options.videoSrc) { return defaultResult }
            var video = new _videoWorker2["default"](self.options.videoSrc, { autoplay: true, loop: self.options.videoLoop, showContols: false, startTime: self.options.videoStartTime || 0, endTime: self.options.videoEndTime || 0, mute: self.options.videoVolume ? 0 : 1, volume: self.options.videoVolume || 0 });
            if (video.isValid()) {
                if (!defaultResult) {
                    ...
                    video.on("ready", function() {
                        if (self.options.videoPlayOnlyVisible) {
                            ...
                            self.onScroll = function() { oldOnScroll.apply(self); if (self.options.videoLoop || !self.options.videoLoop && !self.videoEnded) { if (self.isVisible()) { video.play() } else { video.pause() } } }
                        } else { video.play() }
                    });
...
(function(modules) {
    ...
    function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj } }(0, _jarallaxElement2["default"])();
    (0, _liteReady2["default"])(function() { if (typeof jarallax !== "undefined") { jarallax(document.querySelectorAll("[data-jarallax-element]")) } })
}, function(module, exports, __webpack_require__) {
    "use strict";
    module.exports = function(callback) { if (document.readyState === "complete" || document.readyState === "interactive") { callback.call() } else if (document.attachEvent) { document.attachEvent("onreadystatechange", function() { if (document.readyState === "interactive") callback.call() }) } else if (document.addEventListener) { document.addEventListener("DOMContentLoaded", callback) } }
}, function(module, exports, __webpack_require__) {
...
(function(global, factory) { if (typeof define == "function" && define.amd) { define("ev-emitter/ev-emitter", factory) } else if (typeof module == "object" && module.exports) { module.exports = factory() } else { global.EvEmitter = factory() } })(typeof window != "undefined" ? window : this, function() {
    ...
    proto.on = function(eventName, listener) { if (!eventName || !listener) { return } var events = this._events = this._events || {}; var listeners = events[eventName] = events[eventName] || []; if (listeners.indexOf(listener) == -1) { listeners.push(listener) } return this };
    ...
    proto.off = function(eventName, listener) { var listeners = this._events && this._events[eventName]; if (!listeners || !listeners.length) { return } var index = listeners.indexOf(listener); if (index != -1) { listeners.splice(index, 1) } return this };
...
(function(window, factory) { "use strict"; if (typeof define == "function" && define.amd) { define(["ev-emitter/ev-emitter"], function(EvEmitter) { return factory(window, EvEmitter) }) } else if (typeof module == "object" && module.exports) { module.exports = factory(window, require("ev-emitter")) } else { window.imagesLoaded = factory(window, window.EvEmitter) } })(typeof window !== "undefined" ? window : this, function factory(window, EvEmitter) {
    ...
    function makeArray(obj) { if (Array.isArray(obj)) { return obj } var isArrayLike = typeof obj == "object" && typeof obj.length == "number"; if (isArrayLike) { return arraySlice.call(obj) } return [obj] }
    ...
    LoadingImage.prototype.check = function() {
        ...
        if (isComplete) { this.confirm(this.img.naturalWidth !== 0, "naturalWidth"); return }
    ...
    LoadingImage.prototype.getIsImageComplete = function() { return this.img.complete && this.img.naturalWidth };
    ...
    function jQueryBridget(namespace, PluginClass, $) {
        ...
        function methodCall($elems, methodName, args) {
            ...
            $elems.each(function(i, elem) {
                ...
                if (!instance) { logError(namespace + " not initialized. Cannot call methods, i.e. " + pluginMethodStr); return }
...
(function(window, factory) { if (typeof define == "function" && define.amd) { define("get-size/get-size", factory) } else if (typeof module == "object" && module.exports) { module.exports = factory() } else { window.getSize = factory() } })(window, function factory() {
    ...
    function getStyle(elem) { var style = getComputedStyle(elem); if (!style) { logError("Style returned " + style + ". Are you running this code in a hidden iframe on Firefox? " + "See https://bit.ly/getsizebug1") } return style }
    var isSetup = false;
    var isBoxSizeOuter;
...
(function(window, factory) { if (typeof define == "function" && define.amd) { define("fizzy-ui-utils/utils", ["desandro-matches-selector/matches-selector"], function(matchesSelector) { return factory(window, matchesSelector) }) } else if (typeof module == "object" && module.exports) { module.exports = factory(window, require("desandro-matches-selector")) } else { window.fizzyUIUtils = factory(window, window.matchesSelector) } })(window, function factory(window, matchesSelector) {
    ...
    var arraySlice = Array.prototype.slice;
    utils.makeArray = function(obj) { if (Array.isArray(obj)) { return obj } if (obj === null || obj === undefined) { return [] } var isArrayLike = typeof obj == "object" && typeof obj.length == "number"; if (isArrayLike) { return arraySlice.call(obj) } return [obj] };
    ...
    utils.filterFindElements = function(elems, selector) {
        ...
        var ffElems = [];
        elems.forEach(function(elem) { if (!(elem instanceof HTMLElement)) { return } if (!selector) { ffElems.push(elem); return } if (matchesSelector(elem, selector)) { ffElems.push(elem) } var childElems = elem.querySelectorAll(selector); for (var i = 0; i < childElems.length; i++) { ffElems.push(childElems[i]) } });
        return ffElems
    };
    ...
    utils.htmlInit = function(WidgetClass, namespace) {
        utils.docReady(function() {
            ...
            elems.forEach(function(elem) { var attr = elem.getAttribute(dataAttr) || elem.getAttribute(dataOptionsAttr); var options; try { options = attr && JSON.parse(attr) } catch (error) { if (console) { console.error("Error parsing " + dataAttr + " on " + elem.className + ": " + error) } return } var instance = new WidgetClass(elem, options); if (jQuery) { jQuery.data(elem, namespace, instance) } })
        })
    };
    return utils
});
(function(window, factory) {
    ...
    proto.getHideRevealTransitionEndProperty = function(styleProperty) { var optionStyle = this.layout.options[styleProperty]; if (optionStyle.opacity) { return "opacity" } for (var prop in optionStyle) { return prop } };
    proto.hide = function() {
        this.isHidden = true;
        this.css({ display: "" });
        var options = this.layout.options;
...
(function(window, factory) { "use strict"; if (typeof define == "function" && define.amd) { define("outlayer/outlayer", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item"], function(EvEmitter, getSize, utils, Item) { return factory(window, EvEmitter, getSize, utils, Item) }) } else if (typeof module == "object" && module.exports) { module.exports = factory(window, require("ev-emitter"), require("get-size"), require("fizzy-ui-utils"), require("./item")) } else { window.Outlayer = factory(window, window.EvEmitter, window.getSize, window.fizzyUIUtils, window.Outlayer.Item) } })(window, function factory(window, EvEmitter, getSize, utils, Item) {
    ...
    function Outlayer(element, options) {
        ...
        if (!queryElement) { if (console) { console.error("Bad element for " + this.constructor.namespace + ": " + (queryElement || element)) } return }
    ...
    proto.addItems = function(elems) { var items = this._itemize(elems); if (items.length) { this.items = this.items.concat(items) } return items };
...
(function(window, factory) { if (typeof define == "function" && define.amd) { define("masonry-layout/masonry", ["outlayer/outlayer", "get-size/get-size"], factory) } else if (typeof module == "object" && module.exports) { module.exports = factory(require("outlayer"), require("get-size")) } else { window.Masonry = factory(window.Outlayer, window.getSize) } })(window, function factory(Outlayer, getSize) {
    ...
    proto._getTopColGroup = function(colSpan) { if (colSpan < 2) { return this.colYs } var colGroup = []; var groupCount = this.cols + 1 - colSpan; for (var i = 0; i < groupCount; i++) { colGroup[i] = this._getColGroupY(i, colSpan) } return colGroup };
    proto._getColGroupY = function(col, colSpan) { if (colSpan < 2) { return this.colYs[col] } var groupColYs = this.colYs.slice(col, col + colSpan); return Math.max.apply(Math, groupColYs) };
    ...
    proto._getContainerSize = function() { this.maxY = Math.max.apply(Math, this.colYs); var size = { height: this.maxY }; if (this._getOption("fitWidth")) { size.width = this._getContainerFitWidth() } return size };
...
(function(window, factory) { if (typeof define == "function" && define.amd) { define("isotope-layout/js/layout-modes/masonry", ["../layout-mode", "masonry-layout/masonry"], factory) } else if (typeof module == "object" && module.exports) { module.exports = factory(require("../layout-mode"), require("masonry-layout")) } else { factory(window.Isotope.LayoutMode, window.Masonry) } })(window, function factory(LayoutMode, Masonry) {
    ...
    proto._getOption = function(option) { if (option == "fitWidth") { return this.options.isFitWidth !== undefined ? this.options.isFitWidth : this.options.fitWidth } return _getOption.apply(this.isotope, arguments) };
    return MasonryMode
});
...
(function(window, factory) { if (typeof define == "function" && define.amd) { define(["outlayer/outlayer", "get-size/get-size", "desandro-matches-selector/matches-selector", "fizzy-ui-utils/utils", "isotope-layout/js/item", "isotope-layout/js/layout-mode", "isotope-layout/js/layout-modes/masonry", "isotope-layout/js/layout-modes/fit-rows", "isotope-layout/js/layout-modes/vertical"], function(Outlayer, getSize, matchesSelector, utils, Item, LayoutMode) { return factory(window, Outlayer, getSize, matchesSelector, utils, Item, LayoutMode) }) } else if (typeof module == "object" && module.exports) { module.exports = factory(window, require("outlayer"), require("get-size"), require("desandro-matches-selector"), require("fizzy-ui-utils"), require("isotope-layout/js/item"), require("isotope-layout/js/layout-mode"), require("isotope-layout/js/layout-modes/masonry"), require("isotope-layout/js/layout-modes/fit-rows"), require("isotope-layout/js/layout-modes/vertical")) } else { window.Isotope = factory(window, window.Outlayer, window.getSize, window.matchesSelector, window.fizzyUIUtils, window.Isotope.Item, window.Isotope.LayoutMode) } })(window, function factory(window, Outlayer, getSize, matchesSelector, utils, Item, LayoutMode) {
    ...
    proto._filter = function(items) {
        ...
        for (var i = 0; i < items.length; i++) { var item = items[i]; if (item.isIgnored) { continue } var isMatched = test(item); if (isMatched) { matches.push(item) } if (isMatched && item.isHidden) { hiddenMatched.push(item) } else if (!isMatched && !item.isHidden) { visibleUnmatched.push(item) } }
        return { matches: matches, needReveal: hiddenMatched, needHide: visibleUnmatched }
    };
    proto._getFilterTest = function(filter) { if (jQuery && this.options.isJQueryFiltering) { return function(item) { return jQuery(item.element).is(filter) } } if (typeof filter == "function") { return function(item) { return filter(item.element) } } return function(item) { return matchesSelector(item.element, filter) } };
    ...
    var mungeSorter = function() {
        ...
        function getValueGetter(attr, query) { if (attr) { return function getAttribute(elem) { return elem.getAttribute(attr) } } return function getChildText(elem) { var child = elem.querySelector(query); return child && child.textContent } }
        return mungeSorter
    }();
    ...
    proto._getIsSameSortBy = function(sortBys) { for (var i = 0; i < sortBys.length; i++) { if (sortBys[i] != this.sortHistory[i]) { return false } } return true };
...
(function(global, factory) { typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global = global || self, global.Swiper = factory()) })(this, function() {
    "use strict";
    ...
    function $(selector, context) {
        ...
        if (selector) {
            if (typeof selector === "string") {
                ...
                } else { if (!context && selector[0] === "#" && !selector.match(/[ .<>:~]/)) { els = [doc.getElementById(selector.trim().split("#")[1])] } else { els = (context || doc).querySelectorAll(selector.trim()) } for (i = 0; i < els.length; i += 1) { if (els[i]) { arr.push(els[i]) } } }
    ...
    function unique(arr) { var uniqueArray = []; for (var i = 0; i < arr.length; i += 1) { if (uniqueArray.indexOf(arr[i]) === -1) { uniqueArray.push(arr[i]) } } return uniqueArray }

    function addClass(className) { if (typeof className === "undefined") { return this } var classes = className.split(" "); for (var i = 0; i < classes.length; i += 1) { for (var j = 0; j < this.length; j += 1) { if (typeof this[j] !== "undefined" && typeof this[j].classList !== "undefined") { this[j].classList.add(classes[i]) } } } return this }

    function removeClass(className) { var classes = className.split(" "); for (var i = 0; i < classes.length; i += 1) { for (var j = 0; j < this.length; j += 1) { if (typeof this[j] !== "undefined" && typeof this[j].classList !== "undefined") { this[j].classList.remove(classes[i]) } } } return this }

    function hasClass(className) { if (!this[0]) { return false } return this[0].classList.contains(className) }

    function toggleClass(className) { var classes = className.split(" "); for (var i = 0; i < classes.length; i += 1) { for (var j = 0; j < this.length; j += 1) { if (typeof this[j] !== "undefined" && typeof this[j].classList !== "undefined") { this[j].classList.toggle(classes[i]) } } } return this }

    function attr(attrs, value) {
        var arguments$1 = arguments;
        if (arguments.length === 1 && typeof attrs === "string") { if (this[0]) { return this[0].getAttribute(attrs) } return undefined }
        for (var i = 0; i < this.length; i += 1) {
            if (arguments$1.length === 2) { this[i].setAttribute(attrs, value) } else {
    ...
    function data(key, value) {
        var el;
        if (typeof value === "undefined") { el = this[0]; if (el) { if (el.dom7ElementDataStorage && key in el.dom7ElementDataStorage) { return el.dom7ElementDataStorage[key] } var dataKey = el.getAttribute("data-" + key); if (dataKey) { return dataKey } return undefined } return undefined }
        for (var i = 0; i < this.length; i += 1) {
            el = this[i];
    ...
    function on() {
        ...
        function handleLiveEvent(e) { var target = e.target; if (!target) { return } var eventData = e.target.dom7EventData || []; if (eventData.indexOf(e) < 0) { eventData.unshift(e) } if ($(target).is(targetSelector)) { listener.apply(target, eventData) } else { var parents = $(target).parents(); for (var k = 0; k < parents.length; k += 1) { if ($(parents[k]).is(targetSelector)) { listener.apply(parents[k], eventData) } } } }
    ...
    function offset() { if (this.length > 0) { var el = this[0]; var box = el.getBoundingClientRect(); var body = doc.body; var clientTop = el.clientTop || body.clientTop || 0; var clientLeft = el.clientLeft || body.clientLeft || 0; var scrollTop = el === win ? win.scrollY : el.scrollTop; var scrollLeft = el === win ? win.scrollX : el.scrollLeft; return { top: box.top + scrollTop - clientTop, left: box.left + scrollLeft - clientLeft } } return null }

    function styles() { if (this[0]) { return win.getComputedStyle(this[0], null) } return {} }

    function css(props, value) { var i; if (arguments.length === 1) { if (typeof props === "string") { if (this[0]) { return win.getComputedStyle(this[0], null).getPropertyValue(props) } } else { for (i = 0; i < this.length; i += 1) { for (var prop in props) { this[i].style[prop] = props[prop] } } return this } } if (arguments.length === 2 && typeof props === "string") { for (i = 0; i < this.length; i += 1) { this[i].style[props] = value } return this } return this }

    function each(callback) { if (!callback) { return this } for (var i = 0; i < this.length; i += 1) { if (callback.call(this[i], i, this[i]) === false) { return this } } return this }

    function html(html) { if (typeof html === "undefined") { return this[0] ? this[0].innerHTML : undefined } for (var i = 0; i < this.length; i += 1) { this[i].innerHTML = html } return this }

    function text(text) { if (typeof text === "undefined") { if (this[0]) { return this[0].textContent.trim() } return null } for (var i = 0; i < this.length; i += 1) { this[i].textContent = text } return this }
    ...
    function is(selector) {
        ...
        if (selector.nodeType || selector instanceof Dom7) { compareWith = selector.nodeType ? [selector] : selector; for (i = 0; i < compareWith.length; i += 1) { if (compareWith[i] === el) { return true } } return false }
        return false
    }

    function index() { var child = this[0]; var i; if (child) { i = 0; while ((child = child.previousSibling) !== null) { if (child.nodeType === 1) { i += 1 } } return i } return undefined }

    function eq(index) { if (typeof index === "undefined") { return this } var length = this.length; var returnIndex; if (index > length - 1) { return new Dom7([]) } if (index < 0) { returnIndex = length + index; if (returnIndex < 0) { return new Dom7([]) } return new Dom7([this[returnIndex]]) } return new Dom7([this[index]]) }
    ...
    function next(selector) { if (this.length > 0) { if (selector) { if (this[0].nextElementSibling && $(this[0].nextElementSibling).is(selector)) { return new Dom7([this[0].nextElementSibling]) } return new Dom7([]) } if (this[0].nextElementSibling) { return new Dom7([this[0].nextElementSibling]) } return new Dom7([]) } return new Dom7([]) }
    ...
    function prev(selector) { if (this.length > 0) { var el = this[0]; if (selector) { if (el.previousElementSibling && $(el.previousElementSibling).is(selector)) { return new Dom7([el.previousElementSibling]) } return new Dom7([]) } if (el.previousElementSibling) { return new Dom7([el.previousElementSibling]) } return new Dom7([]) } return new Dom7([]) }
    ...
    function parent(selector) { var parents = []; for (var i = 0; i < this.length; i += 1) { if (this[i].parentNode !== null) { if (selector) { if ($(this[i].parentNode).is(selector)) { parents.push(this[i].parentNode) } } else { parents.push(this[i].parentNode) } } } return $(unique(parents)) }
    ...
    function closest(selector) { var closest = this; if (typeof selector === "undefined") { return new Dom7([]) } if (!closest.is(selector)) { closest = closest.parents(selector).eq(0) } return closest }

    function find(selector) { var foundElements = []; for (var i = 0; i < this.length; i += 1) { var found = this[i].querySelectorAll(selector); for (var j = 0; j < found.length; j += 1) { foundElements.push(found[j]) } } return new Dom7(foundElements) }

    function children(selector) { var children = []; for (var i = 0; i < this.length; i += 1) { var childNodes = this[i].childNodes; for (var j = 0; j < childNodes.length; j += 1) { if (!selector) { if (childNodes[j].nodeType === 1) { children.push(childNodes[j]) } } else if (childNodes[j].nodeType === 1 && $(childNodes[j]).is(selector)) { children.push(childNodes[j]) } } } return new Dom7(unique(children)) }

    function remove() { for (var i = 0; i < this.length; i += 1) { if (this[i].parentNode) { this[i].parentNode.removeChild(this[i]) } } return this }
    ...
    var Support = function Support() {
        ...
        return {
            touch: win.Modernizr && win.Modernizr.touch === true || function checkTouch() { return !!(win.navigator.maxTouchPoints > 0 || "ontouchstart" in win || win.DocumentTouch && doc instanceof win.DocumentTouch) }(),
            ...
            flexbox: function checkFlexbox() { var style = testDiv.style; var styles = "alignItems webkitAlignItems webkitBoxAlign msFlexAlign mozBoxAlign webkitFlexDirection msFlexDirection mozBoxDirection mozBoxOrient webkitBoxDirection webkitBoxOrient".split(" "); for (var i = 0; i < styles.length; i += 1) { if (styles[i] in style) { return true } } return false }(),
    ...
    var Browser = function Browser() {
        ...
        return { isIE: !!win.navigator.userAgent.match(/Trident/g) || !!win.navigator.userAgent.match(/MSIE/g), isEdge: !!win.navigator.userAgent.match(/Edge/g), isSafari: isSafari(), isUiWebView: /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(win.navigator.userAgent) }
    }();
    ...
    function updateSlides() {
        ...
        for (var i = 0; i < slidesLength; i += 1) {
            ...
            if (params.slidesPerView === "auto") { var slideStyles = win.getComputedStyle(slide[0], null); var currentTransform = slide[0].style.transform; var currentWebKitTransform = slide[0].style.webkitTransform; if (currentTransform) { slide[0].style.transform = "none" } if (currentWebKitTransform) { slide[0].style.webkitTransform = "none" } if (params.roundLengths) { slideSize = swiper.isHorizontal() ? slide.outerWidth(true) : slide.outerHeight(true) } else { if (swiper.isHorizontal()) { var width = parseFloat(slideStyles.getPropertyValue("width")); var paddingLeft = parseFloat(slideStyles.getPropertyValue("padding-left")); var paddingRight = parseFloat(slideStyles.getPropertyValue("padding-right")); var marginLeft = parseFloat(slideStyles.getPropertyValue("margin-left")); var marginRight = parseFloat(slideStyles.getPropertyValue("margin-right")); var boxSizing = slideStyles.getPropertyValue("box-sizing"); if (boxSizing && boxSizing === "border-box") { slideSize = width + marginLeft + marginRight } else { slideSize = width + paddingLeft + paddingRight + marginLeft + marginRight } } else { var height = parseFloat(slideStyles.getPropertyValue("height")); var paddingTop = parseFloat(slideStyles.getPropertyValue("padding-top")); var paddingBottom = parseFloat(slideStyles.getPropertyValue("padding-bottom")); var marginTop = parseFloat(slideStyles.getPropertyValue("margin-top")); var marginBottom = parseFloat(slideStyles.getPropertyValue("margin-bottom")); var boxSizing$1 = slideStyles.getPropertyValue("box-sizing"); if (boxSizing$1 && boxSizing$1 === "border-box") { slideSize = height + marginTop + marginBottom } else { slideSize = height + paddingTop + paddingBottom + marginTop + marginBottom } } } if (currentTransform) { slide[0].style.transform = currentTransform } if (currentWebKitTransform) { slide[0].style.webkitTransform = currentWebKitTransform } if (params.roundLengths) { slideSize = Math.floor(slideSize) } } else { slideSize = (swiperSize - (params.slidesPerView - 1) * spaceBetween) / params.slidesPerView; if (params.roundLengths) { slideSize = Math.floor(slideSize) } if (slides[i]) { if (swiper.isHorizontal()) { slides[i].style.width = slideSize + "px" } else { slides[i].style.height = slideSize + "px" } } }
        ...
        if (params.slidesPerColumn > 1) {
            ...
            if (params.centeredSlides) {
                newSlidesGrid = [];
                for (var i$1 = 0; i$1 < snapGrid.length; i$1 += 1) { var slidesGridItem = snapGrid[i$1]; if (params.roundLengths) { slidesGridItem = Math.floor(slidesGridItem) } if (snapGrid[i$1] < swiper.virtualSize + snapGrid[0]) { newSlidesGrid.push(slidesGridItem) } }
                snapGrid = newSlidesGrid
            }
        }
        if (!params.centeredSlides) {
            newSlidesGrid = [];
            for (var i$2 = 0; i$2 < snapGrid.length; i$2 += 1) { var slidesGridItem$1 = snapGrid[i$2]; if (params.roundLengths) { slidesGridItem$1 = Math.floor(slidesGridItem$1) } if (snapGrid[i$2] <= swiper.virtualSize - swiperSize) { newSlidesGrid.push(slidesGridItem$1) } }
            snapGrid = newSlidesGrid;
    ...
    function getTranslate(axis) { if (axis === void 0) axis = this.isHorizontal() ? "x" : "y"; var swiper = this; var params = swiper.params; var rtl = swiper.rtlTranslate; var translate = swiper.translate; var $wrapperEl = swiper.$wrapperEl; if (params.virtualTranslate) { return rtl ? -translate : translate } var currentTranslate = Utils.getTranslate($wrapperEl[0], axis); if (rtl) { currentTranslate = -currentTranslate } return currentTranslate || 0 }
    ...
    function appendSlide(slides) { var swiper = this; var $wrapperEl = swiper.$wrapperEl; var params = swiper.params; if (params.loop) { swiper.loopDestroy() } if (typeof slides === "object" && "length" in slides) { for (var i = 0; i < slides.length; i += 1) { if (slides[i]) { $wrapperEl.append(slides[i]) } } } else { $wrapperEl.append(slides) } if (params.loop) { swiper.loopCreate() } if (!(params.observer && Support.observer)) { swiper.update() } }
    ...
    function removeSlide(slidesIndexes) {
        ...
        if (typeof slidesIndexes === "object" && "length" in slidesIndexes) {
            for (var i = 0; i < slidesIndexes.length; i += 1) { indexToRemove = slidesIndexes[i]; if (swiper.slides[indexToRemove]) { swiper.slides.eq(indexToRemove).remove() } if (indexToRemove < newActiveIndex) { newActiveIndex -= 1 } }
    ...
    function onTouchStart(event) {
        ...
        if (e.type !== "touchstart") { var preventDefault = true; if ($(e.target).is(data.formElements)) { preventDefault = false } if (doc.activeElement && $(doc.activeElement).is(data.formElements) && doc.activeElement !== e.target) { doc.activeElement.blur() } var shouldPreventDefault = preventDefault && swiper.allowTouchMove && params.touchStartPreventDefault; if (params.touchStartForcePreventDefault || shouldPreventDefault) { e.preventDefault() } }
    ...
    function onTouchMove(event) {
        ...
        var e = event;
        if (e.originalEvent) { e = e.originalEvent }
        if (!data.isTouched) { if (data.startMoving && data.isScrolling) { swiper.emit("touchMoveOpposite", e) } return }
    ...
    function onTouchEnd(event) {
        ...
        if (timeDiff > params.longSwipesMs) { if (!params.longSwipes) { swiper.slideTo(swiper.activeIndex); return } if (swiper.swipeDirection === "next") { if (ratio >= params.longSwipesRatio) { swiper.slideTo(stopIndex + params.slidesPerGroup) } else { swiper.slideTo(stopIndex) } } if (swiper.swipeDirection === "prev") { if (ratio > 1 - params.longSwipesRatio) { swiper.slideTo(stopIndex + params.slidesPerGroup) } else { swiper.slideTo(stopIndex) } } } else { if (!params.shortSwipes) { swiper.slideTo(swiper.activeIndex); return } if (swiper.swipeDirection === "next") { swiper.slideTo(stopIndex + params.slidesPerGroup) } if (swiper.swipeDirection === "prev") { swiper.slideTo(stopIndex) } }
    }
    ...
    function setBreakpoint() {
        ...
        if (breakpoint && swiper.currentBreakpoint !== breakpoint) {
            ...
            if (breakpointOnlyParams) {
                ["slidesPerView", "spaceBetween", "slidesPerGroup"].forEach(function(param) { var paramValue = breakpointOnlyParams[param]; if (typeof paramValue === "undefined") { return } if (param === "slidesPerView" && (paramValue === "AUTO" || paramValue === "auto")) { breakpointOnlyParams[param] = "auto" } else if (param === "slidesPerView") { breakpointOnlyParams[param] = parseFloat(paramValue) } else { breakpointOnlyParams[param] = parseInt(paramValue, 10) } })
            }
    ...
    function getBreakpoint(breakpoints) {
        ...
        for (var i = 0; i < points.length; i += 1) { var point = points[i]; if (swiper.params.breakpointsInverse) { if (point <= win.innerWidth) { breakpoint = point } } else if (point >= win.innerWidth && !breakpoint) { breakpoint = point } }
    ...
    var Swiper = function(SwiperClass) {
        function Swiper() {
            ...
            var el;
            var params;
            if (args.length === 1 && args[0].constructor && args[0].constructor === Object) { params = args[0] } else { assign = args, el = assign[0], params = assign[1] }
            if (!params) { params = {} }
            ...
            Object.keys(swiper.modules).forEach(function(moduleName) { var module = swiper.modules[moduleName]; if (module.params) { var moduleParamName = Object.keys(module.params)[0]; var moduleParams = module.params[moduleParamName]; if (typeof moduleParams !== "object" || moduleParams === null) { return } if (!(moduleParamName in params && "enabled" in moduleParams)) { return } if (params[moduleParamName] === true) { params[moduleParamName] = { enabled: true } } if (typeof params[moduleParamName] === "object" && !("enabled" in params[moduleParamName])) { params[moduleParamName].enabled = true } if (!params[moduleParamName]) { params[moduleParamName] = { enabled: false } } } });
        ...
        Swiper.prototype.update = function update() {
            ...
            var translated;
            if (swiper.params.freeMode) { setTranslate(); if (swiper.params.autoHeight) { swiper.updateAutoHeight() } } else { if ((swiper.params.slidesPerView === "auto" || swiper.params.slidesPerView > 1) && swiper.isEnd && !swiper.params.centeredSlides) { translated = swiper.slideTo(swiper.slides.length - 1, 0, false, true) } else { translated = swiper.slideTo(swiper.activeIndex, 0, false, true) } if (!translated) { setTranslate() } }
        ...
        Swiper.prototype.changeDirection = function changeDirection(newDirection, needUpdate) {
            ...
            swiper.slides.each(function(slideIndex, slideEl) { if (newDirection === "vertical") { slideEl.style.width = "" } else { slideEl.style.height = "" } });
    ...
    var Observer = {
        ...
        attach: function attach(target, options) {
            ...
            var observer = new ObserverFunc(function(mutations) { if (mutations.length === 1) { swiper.emit("observerUpdate", mutations[0]); return } var observerUpdate = function observerUpdate() { swiper.emit("observerUpdate", mutations[0]) }; if (win.requestAnimationFrame) { win.requestAnimationFrame(observerUpdate) } else { win.setTimeout(observerUpdate, 0) } });
    ...
    var Virtual = {
        update: function update(force) {
            ...
            if (swiper.params.virtual.renderExternal) {
                swiper.params.virtual.renderExternal.call(swiper, { offset: offset, from: from, to: to, slides: function getSlides() { var slidesToRender = []; for (var i = from; i <= to; i += 1) { slidesToRender.push(slides[i]) } return slidesToRender }() });
                onRendered();
                return
            }
            var prependIndexes = [];
            ...
            for (var i$1 = 0; i$1 < slides.length; i$1 += 1) { if (i$1 >= from && i$1 <= to) { if (typeof previousTo === "undefined" || force) { appendIndexes.push(i$1) } else { if (i$1 > previousTo) { appendIndexes.push(i$1) } if (i$1 < previousFrom) { prependIndexes.push(i$1) } } } }
        ...
        renderSlide: function renderSlide(slide, index) { var swiper = this; var params = swiper.params.virtual; if (params.cache && swiper.virtual.cache[index]) { return swiper.virtual.cache[index] } var $slideEl = params.renderSlide ? $(params.renderSlide.call(swiper, slide, index)) : $('<div class="' + swiper.params.slideClass + '" data-swiper-slide-index="' + index + '">' + slide + "</div>"); if (!$slideEl.attr("data-swiper-slide-index")) { $slideEl.attr("data-swiper-slide-index", index) } if (params.cache) { swiper.virtual.cache[index] = $slideEl } return $slideEl },
        ...
        prependSlide: function prependSlide(slides) {
            ...
            if (swiper.params.virtual.cache) {
                ...
                var newCache = {};
                Object.keys(cache).forEach(function(cachedIndex) { newCache[parseInt(cachedIndex, 10) + numberOfNewSlides] = cache[cachedIndex] });
    ...
    var Virtual$1 = {
        ...
        create: function create() {
            var swiper = this;
            Utils.extend(swiper, { virtual: { update: Virtual.update.bind(swiper), appendSlide: Virtual.appendSlide.bind(swiper), prependSlide: Virtual.prependSlide.bind(swiper), removeSlide: Virtual.removeSlide.bind(swiper), removeAllSlides: Virtual.removeAllSlides.bind(swiper), renderSlide: Virtual.renderSlide.bind(swiper), slides: swiper.params.virtual.slides, cache: {} } })
        },
        on: {
    ...
    var Keyboard = {
        handle: function handle(event) {
            ...
            if (swiper.isHorizontal()) { if (kc === 37 || kc === 39) { if (e.preventDefault) { e.preventDefault() } else { e.returnValue = false } } if (kc === 39 && !rtl || kc === 37 && rtl) { swiper.slideNext() } if (kc === 37 && !rtl || kc === 39 && rtl) { swiper.slidePrev() } } else { if (kc === 38 || kc === 40) { if (e.preventDefault) { e.preventDefault() } else { e.returnValue = false } } if (kc === 40) { swiper.slideNext() } if (kc === 38) { swiper.slidePrev() } }
    ...
    var Mousewheel = {
        ...
        event: function getEvent() { if (win.navigator.userAgent.indexOf("firefox") > -1) { return "DOMMouseScroll" } return isEventSupported() ? "wheel" : "mousewheel" }(),
    ...
    var Navigation$1 = {
        ...
        create: function create() {
            var swiper = this;
            Utils.extend(swiper, { navigation: { init: Navigation.init.bind(swiper), update: Navigation.update.bind(swiper), destroy: Navigation.destroy.bind(swiper), onNextClick: Navigation.onNextClick.bind(swiper), onPrevClick: Navigation.onPrevClick.bind(swiper) } })
        },
        on: {
            init: function init() {
                var swiper = this;
            ...
            click: function click(e) { var swiper = this; var ref = swiper.navigation; var $nextEl = ref.$nextEl; var $prevEl = ref.$prevEl; if (swiper.params.navigation.hideOnClick && !$(e.target).is($prevEl) && !$(e.target).is($nextEl)) { var isHidden; if ($nextEl) { isHidden = $nextEl.hasClass(swiper.params.navigation.hiddenClass) } else if ($prevEl) { isHidden = $prevEl.hasClass(swiper.params.navigation.hiddenClass) } if (isHidden === true) { swiper.emit("navigationShow", swiper) } else { swiper.emit("navigationHide", swiper) } if ($nextEl) { $nextEl.toggleClass(swiper.params.navigation.hiddenClass) } if ($prevEl) { $prevEl.toggleClass(swiper.params.navigation.hiddenClass) } } }
        }
    };
    var Pagination = {
        update: function update() {
            ...
            if (swiper.params.loop) { current = Math.ceil((swiper.activeIndex - swiper.loopedSlides) / swiper.params.slidesPerGroup); if (current > slidesLength - 1 - swiper.loopedSlides * 2) { current -= slidesLength - swiper.loopedSlides * 2 } if (current > total - 1) { current -= total } if (current < 0 && swiper.params.paginationType !== "bullets") { current = total + current } } else if (typeof swiper.snapIndex !== "undefined") { current = swiper.snapIndex } else { current = swiper.activeIndex || 0 }
    ...
    var Zoom = {
        getDistanceBetweenTouches: function getDistanceBetweenTouches(e) { if (e.targetTouches.length < 2) { return 1 } var x1 = e.targetTouches[0].pageX; var y1 = e.targetTouches[0].pageY; var x2 = e.targetTouches[1].pageX; var y2 = e.targetTouches[1].pageY; var distance = Math.sqrt(Math.pow(x2 - x1, 2) + Math.pow(y2 - y1, 2)); return distance },
    ...
    var Lazy = {
        ...
        load: function load() {
            ...
            function slideIndex(slideEl) { if (isVirtual) { return $(slideEl).attr("data-swiper-slide-index") } return $(slideEl).index() }
    ...
    var a11y = {
        ...
        onEnterKey: function onEnterKey(e) { var swiper = this; var params = swiper.params.a11y; if (e.keyCode !== 13) { return } var $targetEl = $(e.target); if (swiper.navigation && swiper.navigation.$nextEl && $targetEl.is(swiper.navigation.$nextEl)) { if (!(swiper.isEnd && !swiper.params.loop)) { swiper.slideNext() } if (swiper.isEnd) { swiper.a11y.notify(params.lastSlideMessage) } else { swiper.a11y.notify(params.nextSlideMessage) } } if (swiper.navigation && swiper.navigation.$prevEl && $targetEl.is(swiper.navigation.$prevEl)) { if (!(swiper.isBeginning && !swiper.params.loop)) { swiper.slidePrev() } if (swiper.isBeginning) { swiper.a11y.notify(params.firstSlideMessage) } else { swiper.a11y.notify(params.prevSlideMessage) } } if (swiper.pagination && $targetEl.is("." + swiper.params.pagination.bulletClass)) { $targetEl[0].click() } },
        ...
        updateNavigation: function updateNavigation() { var swiper = this; if (swiper.params.loop) { return } var ref = swiper.navigation; var $nextEl = ref.$nextEl; var $prevEl = ref.$prevEl; if ($prevEl && $prevEl.length > 0) { if (swiper.isBeginning) { swiper.a11y.disableEl($prevEl) } else { swiper.a11y.enableEl($prevEl) } } if ($nextEl && $nextEl.length > 0) { if (swiper.isEnd) { swiper.a11y.disableEl($nextEl) } else { swiper.a11y.enableEl($nextEl) } } },
    ...
    var History = {
        ...
        setHistory: function setHistory(key, index) { var swiper = this; if (!swiper.history.initialized || !swiper.params.history.enabled) { return } var slide = swiper.slides.eq(index); var value = History.slugify(slide.attr("data-history")); if (!win.location.pathname.includes(key)) { value = key + "/" + value } var currentState = win.history.state; if (currentState && currentState.value === value) { return } if (swiper.params.history.replaceState) { win.history.replaceState({ value: value }, null, value) } else { win.history.pushState({ value: value }, null, value) } },
    ...
    var Thumbs = {
        ...
        update: function update(initial) {
            ...
            if (thumbsSwiper.params.loop) { for (var i = 0; i < thumbsToActivate; i += 1) { thumbsSwiper.$wrapperEl.children('[data-swiper-slide-index="' + (swiper.realIndex + i) + '"]').addClass(thumbActiveClass) } } else { for (var i$1 = 0; i$1 < thumbsToActivate; i$1 += 1) { thumbsSwiper.slides.eq(swiper.realIndex + i$1).addClass(thumbActiveClass) } }
        }
    };
    var Thumbs$1 = {
        name: "thumbs",
        ...
        on: {
            ...
            beforeDestroy: function beforeDestroy() { var swiper = this; var thumbsSwiper = swiper.thumbs.swiper; if (!thumbsSwiper) { return } if (swiper.thumbs.swiperCreated && thumbsSwiper) { thumbsSwiper.destroy() } }
        }
    };
...
(function(window, doc) {
    ...
    function grained(ele, opt) {
        ...
        if (typeof ele === "string") { element = doc.getElementById(ele.split("#")[1]) }
        ...
        var options = { animate: true, patternWidth: 100, patternHeight: 100, grainOpacity: .1, grainDensity: 1, grainWidth: 1, grainHeight: 1, grainChaos: .5, grainSpeed: 20 };
        ...
        function addCSSRule(sheet, selector, rules, index) { var ins = ""; if (selector.length) { ins = selector + "{" + rules + "}" } else { ins = rules } if ("insertRule" in sheet) { sheet.insertRule(ins, index) } else if ("addRule" in sheet) { sheet.addRule(selector, rules, index) } }
        ...
        if (animationAdded) { animationAdded.parentElement.removeChild(animationAdded) }
        ...
        if (styleAdded) { styleAdded.parentElement.removeChild(styleAdded) }
...
function initMap() {
    var e = { zoom: 16, center: new google.maps.LatLng(48.859003, 2.345275), mapTypeControl: !1, disableDefaultUI: !0, zoomControl: !1, scrollwheel: !1, styles: [{ stylers: [{ hue: "#ff1a00" }, { invert_lightness: !0 }, { saturation: -100 }, { lightness: 33 }, { gamma: .5 }] }, { featureType: "water", elementType: "geometry", stylers: [{ color: "#2D333C" }] }, { elementType: "labels", stylers: [{ visibility: "off" }] }, { elementType: "labels.icon", stylers: [{ visibility: "off" }] }, { featureType: "administrative.land_parcel", stylers: [{ visibility: "off" }] }, { featureType: "administrative.neighborhood", stylers: [{ visibility: "off" }] }] };
    new google.maps.Map(document.getElementById("map"), e)
}! function(n) {
    "use strict";
    window.onpageshow = function(e) { e.persisted && window.location.reload() }, n(window).on("load", function() {
        var e = n(".preloader");
        e.find(".spinner").fadeOut(function() { e.fadeOut() }), n(".lines").addClass("finish"), setTimeout(function() { n(".lines").addClass("ready") }, 2e3), n(".typed-subtitle").length && 1 < n(".h-subtitle p").length && n(".typed-subtitle").each(function() { n(this).typed({ stringsElement: n(this).prev(".typing-subtitle"), loop: !0 }) }), setTimeout(function() { n(".h-subtitles").addClass("ready"), n(".typed-bread").length && n(".typed-bread").typed({ stringsElement: n(".typing-bread"), showCursor: !1 }) }, 1e3);
        var a = location.hash,
            t = n(a);
        if (0 == a.indexOf("#section-") && t.length && n("body, html").animate({ scrollTop: n(a).offset().top - 68 }, 400), n(".jarallax").length && n(".jarallax").jarallax(), n(".started-carousel").length) {
            var i = new Swiper(".started-carousel .swiper-container", { init: !1, loop: !1, spaceBetween: 0, effect: "fade", slidesPerView: 1, simulateTouch: !1, autoplay: { delay: 6e3, disableOnInteraction: !1, waitForTransition: !1 }, navigation: { nextEl: ".started .swiper-button-next", prevEl: ".started .swiper-button-prev" } });
            i.on("slideChange", function() {
                var t = i.realIndex,
                    s = i.slides.length;
                n(".started-carousel .swiper-slide").removeClass("first"), n(".started-carousel .swiper-slide").each(function(e, a) { e <= t - 1 ? n(a).addClass("swiper-clip-active") : n(a).removeClass("swiper-clip-active") }), n(".started-carousel .swiper-slide").each(function(e, a) { n(a).css({ "z-index": s - e }) })
            }), i.init()
        }
        if (n(".reviews-carousel").length) new Swiper(".reviews-carousel .swiper-container", { loop: !0, spaceBetween: 70, slidesPerView: 2, autoplay: { delay: 6e3 }, navigation: { nextEl: ".reviews-carousel .swiper-button-next", prevEl: ".reviews-carousel .swiper-button-prev" }, breakpoints: { 720: { slidesPerView: 1, spaceBetween: 40 }, 1200: { slidesPerView: 2, spaceBetween: 70 } } });
        setTimeout(function() { n(window).scrollTop(n(window).scrollTop() + 1) }, 100)
    });
    var e = n(window).width(),
        a = n(window).height();
    if (n(".section.started").css({ height: a }), n(".logged-in .section.started").css({ height: a - 32 }), e < 783 && (n(".section.started").css({ height: a }), n(".logged-in .section.started").css({ height: a - 46 })), !n(".grained-off").length) { grained("#grained_container", { animate: !0, patternWidth: 400, patternHeight: 400, grainOpacity: .15, grainDensity: 3, grainWidth: 1, grainHeight: 1 }) }
    1199 < e && (n(document).on("mousemove", function(e) {
        var a = e.pageX,
            t = e.pageY;
        n(".cursor-follower").css("transform", "translate3d(" + a + "px," + t + "px,0px)")
    }), n("a, .btn-group").on({ mouseenter: function(e) { n(".cursor-follower").stop().animate({ width: 86, height: 86, opacity: .1, margin: "-43px 0 0 -43px" }, 500) }, mouseleave: function(e) { n(".cursor-follower").stop().animate({ width: 26, height: 26, opacity: .4, margin: "-13px 0 0 -13px" }, 500) } })), n(".hover-masks a").each(function() {
        var e = n(this).html();
    ...
    }), n(".single-post-text").each(function() { n(this).find("iframe").wrap('<div class="embed-container"></div>') }), setTimeout(function() {
    ...
    }), n("#cform").validate({ rules: { name: { required: !0 }, message: { required: !0 }, email: { required: !0, email: !0 } } })
}(jQuery);